...
Una volta completato questo comando possiamo controllare se effettivamente il server sta funzionando visitando la pagina [http://localhost:9000](localhost:9000):
